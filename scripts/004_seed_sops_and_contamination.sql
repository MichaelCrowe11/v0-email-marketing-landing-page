...
(
  ...
  'fundamentals', -- Changed from 'Sterile Technique' to 'fundamentals' to match check constraint
...
(
  ...
  'substrate', -- Changed from 'Substrate Preparation' to 'substrate'
  'intermediate',
  '2-3 hours',
...
(
  ...
  'environment', -- Changed from 'Environmental Control' to 'environment'
  'intermediate',
