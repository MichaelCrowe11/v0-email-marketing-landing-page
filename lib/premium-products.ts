...
export const courseProducts = {
  masterCourse: {
    id: 'master-course',
    name: 'Master Cultivation Course',
  ...
  facilitySetup: {
    ...
    description: 'Complete facility design for small operations (1-5 grow rooms). Enterprise pricing available for larger projects.',
    price: 50000,
