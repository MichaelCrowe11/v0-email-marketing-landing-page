    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/95 backdrop-blur-sm">
      <div className="w-full max-w-4xl px-6">
        ...
        <div className="flex flex-col items-center gap-6 mb-8">
          <div className="relative">
            ...
            <Image
              ...
              width={120}
              height={120}
              className={`relative rounded-full border-4 border-accent/50 shadow-2xl ${stage !== "initializing" ? "animate-spin-slow" : ""}`}
            />
          ...
          <div className="text-center">
            <h2 className="text-3xl font-bold bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 bg-clip-text text-transparent mb-2">
              Crowe Logic AI
            </h2>
            <p className="text-foreground/70 font-mono text-sm">Building your mycology intelligence platform...</p>
          </div>
        </div>

        {/* Terminal Window */}
        <div className="relative bg-white/95 backdrop-blur-sm border-2 border-accent/40 rounded-xl shadow-2xl overflow-hidden">
          {/* Terminal Header */}
          <div className="flex items-center gap-2 px-4 py-3 bg-gradient-to-r from-foreground/5 to-foreground/10 border-b border-accent/30">
            <div className="flex gap-1.5">
              <div className="w-3 h-3 rounded-full bg-red-500" />
              <div className="w-3 h-3 rounded-full bg-yellow-500" />
              <div className="w-3 h-3 rounded-full bg-green-500" />
            </div>
            <span className="text-xs font-mono font-semibold bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 bg-clip-text text-transparent ml-2">
              crowe-logic-ai.tsx
            </span>
          </div>
          ...
          <div className="p-6 font-mono text-sm h-[400px] overflow-y-auto">
            ...
            {stage === "generating" && (
              <div className="inline-block w-2 h-4 bg-gradient-to-r from-cyan-500 to-purple-500 animate-pulse ml-1" />
            )}
          </div>
          ...
          <div className="px-6 pb-4">
            ...
            <div className="flex justify-between mt-2 text-xs font-mono text-foreground/60">
        ...
        <div className="text-center mt-6">
          <button
            onClick={onComplete}
            className="text-sm text-foreground/50 hover:text-foreground/80 transition-colors font-mono"
          >
            Skip intro →
          </button>
        </div>
